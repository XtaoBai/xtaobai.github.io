...
layout:     post
title:      Cplex 线性规划入门 
subtitle:   运筹优化求解器 Cplex 基于python的线性规划入门
date:       2019-09-20
author:     BXT
...
---
# 线性规划基础
>本文翻译修改自[Tutorial: Linear Programming, (CPLEX Part 1)](https://github.com/IBMDecisionOptimization/docplex-examples/blob/master/examples/mp/jupyter/tutorials/Linear_Programming.ipynb)
>
>*有关对 **CPLEX Linear Programming** 的看法可以看一下这篇课程[ 台湾清华大学 ](https://gold.xitu.io/entry/568bd2ae60b2e57ba2cd2c7b)



![Linear Programming思维导图](http://ww2.sinaimg.cn/large/006y8lVagw1fb7g0gukk8j30m90rl78j.jpg)
...
线性规划（Linear Programming，LP）用于解决线性目标函数的最大值/最小值问题，优化过程受线性约束束缚，其中所有的决策变量都是连续的。也就是说，不允许使用离散变量。先行目标和约束必须由线性表达式组成。

## 什么是线性表达式
线性表达式是一个标量，比如 $\sum_{k=1}^nkx $
